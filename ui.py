...
class UI():
    ...
    def __init__(self):
        ...
        self._leftFrame = Frame(self._root, bg=self._background, width=100, height=500)
        ...
        self._onOffButton = Button(self._leftFrame, text="Turn On/Off", bg="grey", fg="white", width=10, height=2)
        self._onOffButton.grid(row=0, column=0, padx=10, pady=10)
        self._ecoModeButton = Button(self._leftFrame, text="Eco Mode", bg="grey", fg="white", width=10, height=2)
        self._ecoModeButton.grid(row=1, column=0, padx=10, pady=10)
        self._settingsButton = Button(self._leftFrame, text="Settings", bg="grey", fg="white", width=10, height=2)
